...
export default function AddShift() {
  ...
  const handleSubmit = async (e) => {
    ...
    <h1 className="text-3xl font-bold mb-10 text-center text-slate-500">Add Shift</h1>
    ...
    <Link to='/Shiftlist'>
      <div className="bg-slate-600 text-white p-1 rounded-lg uppercase hover:opacity-95 text-center mt-5 w-32 ml-0.5">Shift List</div>
    </Link>
  </div>
                </div>
        
