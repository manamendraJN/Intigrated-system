...
<div className="p-8 w-4/5 ml-72">
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-6 text-center mt-4 text-slate-500">Shift List</h1>
      ...
      <Link to='/Addshift'>
      <div className="bg-slate-600 text-white p-1 rounded-lg uppercase hover:opacity-95 text-center mt-5 w-56 ml-0.5">Add A New Shift</div>
    </Link>
    </div>
    </div>
    </div>
